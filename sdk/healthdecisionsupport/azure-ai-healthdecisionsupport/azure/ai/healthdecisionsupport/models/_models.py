...
class ClinicalTrialDemographics(_model_base.Model):
    ...
    accepted_genders: Optional[List[Union[str, "_models.ClinicalTrialAcceptedGender"]]] = rest_field(
        name="acceptedGenders"
    )
    """A list of genders accepted by a clinical trial. """
    accepted_age_range: Optional["_models.ClinicalTrialDemographicsAcceptedAgeRange"] = rest_field(
        name="acceptedAgeRange"
    )
    ...
    def __init__(
        self,
        *,
        accepted_genders: Optional[List[Union[str, "_models.ClinicalTrialAcceptedGender"]]] = None,
        accepted_age_range: Optional["_models.ClinicalTrialDemographicsAcceptedAgeRange"] = None,
    ):
        ...
...
class ClinicalTrialDemographicsAcceptedAgeRange(_model_base.Model):
    ...
    """A person's age, given as a number (value) and a unit (e.g. years, months). """
    maximum_age: Optional["_models.Age"] = rest_field(name="maximumAge")
    """A person's age, given as a number (value) and a unit (e.g. years, months). """
    ...
    def __init__(
        self,
        *,
        minimum_age: Optional["_models.Age"] = None,
        maximum_age: Optional["_models.Age"] = None,
    ):
        ...
...
Leaving this list empty will not limit the trial facility names. """
    facility_locations: Optional[List["_models.Location"]] = rest_field(name="facilityLocations")
...
Leaving this list empty will not limit the trial facility locations. """
    facility_areas: Optional[List["_models.Area"]] = rest_field(name="facilityAreas")
...
Leaving this list empty will not limit the trial facility area boundaries. """
    ...
    def __init__(
        ...
        *,
        ...
        facility_locations: Optional[List["_models.Location"]] = None,
        facility_areas: Optional[List["_models.Area"]] = None,
    ):
        ...
...
class ModelConfiguration(_model_base.Model):
    """General configuration common to all models.
...
class OncoPhenotypeModelConfiguration(ModelConfiguration):
...
class Request(_model_base.Model):
    """The generic part of the Health Decision Support request, common to all models.
...
class OncoPhenotypeRequest(Request):
...
class OncoPhenotypeResponse(_model_base.Model):
...
class OncoPhenotypeResults(_model_base.Model):
    ...
    model_version: datetime.date = rest_field(name="modelVersion")
...
class Patient(_model_base.Model):
...
class PatientInfo(_model_base.Model):
    ...
    """The patient's gender. Known values are: \"female\", \"male\", and \"unspecified\"."""
    ...
    def __init__(
        self,
        *,
        gender: Optional[Union[str, "_models.PatientInfoGender"]] = None,
...
class TrialMatcherModelConfiguration(ModelConfiguration):
...
class TrialMatcherRequest(Request):
...
class TrialMatcherResponse(_model_base.Model):
