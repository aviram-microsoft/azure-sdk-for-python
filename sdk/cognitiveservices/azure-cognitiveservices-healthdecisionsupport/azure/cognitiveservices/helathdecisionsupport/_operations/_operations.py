...
class TrialMatcherClientOperationsMixin(TrialMatcherClientMixinABC):
    ...
    def create_job(  # pylint: disable=inconsistent-return-statements
        self,
        body: Union[_models.TrialMatcherRequest, JSON],
        *,
        repeatability_request_id: Optional[str] = None,
        repeatability_first_sent: Optional[datetime.datetime] = None,
        ...
        **kwargs: Any
        ...
        :type body: ~healthdecisionsupportapi.models.TrialMatcherRequest or JSON
    ...
    def create_job(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param body: The body of a Trial Matcher request. Is either a model type or a IO type.
         Required.
    ...
    def get_job(self, job_id: str, **kwargs: Any) -> _models.TrialMatcherResponse:
        ...
        :rtype: ~healthdecisionsupportapi.models.TrialMatcherResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
...
class OncoPhenotypeClientOperationsMixin(OncoPhenotypeClientMixinABC):
    ...
    def create_job(  # pylint: disable=inconsistent-return-statements
        self,
        body: Union[_models.OncoPhenotypeRequest, JSON],
        *,
        repeatability_request_id: Optional[str] = None,
        repeatability_first_sent: Optional[datetime.datetime] = None,
        content_type: str = "application/json",
        **kwargs: Any
        ...
        :type body: ~healthdecisionsupportapi.models.OncoPhenotypeRequest or JSON
        :keyword repeatability_request_id: An opaque, globally-unique, client-generated string
         identifier for the request. Default value is None.
        :paramtype repeatability_request_id: str
        :keyword repeatability_first_sent: Specifies the date and time at which the request was first
    ...
    def create_job(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param body: The body of an Onco Phenotype request. Is either a model type or a IO type.
         Required.
    ...
    def get_job(self, job_id: str, **kwargs: Any) -> _models.OncoPhenotypeResponse:
        ...
        :rtype: ~healthdecisionsupportapi.models.OncoPhenotypeResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
